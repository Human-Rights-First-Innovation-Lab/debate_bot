...
AUTH0_BASE_URL = os.getenv("AUTH0_DOMAIN", "https://hrf-production.us.auth0.com/")
AUTH0_M2M_AUDIENCE = os.getenv("AUTH0_AUDIENCE", "https://dbapi.hrfinnovation.org/api/v2/")
